...
const SignUpForm = (props: Props) => {
  ...
  const onSubmit: SubmitHandler<FormInput> = async (data) => {
    ...
    console.log(data); // This is where you can send it to your API
  };
  ...
  return (
    ...
    >
      ...
      <button
        type="submit"
        className="w-full text-white bg-[#197278] hover:bg-green-00 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800"
      >
        Create an account
      </button>
